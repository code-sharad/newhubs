	...
	theme: {
		extend: {
			fontFamily: {
				...
				mono: ['Geist Mono', 'ui-monospace', 'SFMono-Regular', 'Consolas', 'Liberation Mono', 'Menlo', 'monospace'],
			},
			letterSpacing: {
				refined: '-0.025em',
				luxury: '-0.02em',
			...
			boxShadow: {
				...
				'luxury-dark': '0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.05)',
